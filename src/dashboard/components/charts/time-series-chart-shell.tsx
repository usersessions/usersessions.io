...
export interface TimeSeriesChartInnerProps {
  ...
  data: Record<string, unknown>[];
  xDataKey: string;
  /** Formats x-axis and date-pill labels. Default: "Jul 27" (`shortDateFmt`)
   * — pass an hour/minute formatter when the buckets are sub-day, or every
   * label collapses onto the same calendar day. */
