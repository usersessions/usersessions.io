...
export interface AreaProps {
  ...
  stroke?: string;
  /** Stroke opacity for the resting line. Default: 1 */
   ...
   */
  fadeEdges?: FadeEdges;
  /** Opacity this series dims to when another point/series is hovered. Default: 0.6 */
  dimOpacity?: number;
  ...
  /** Loading pulse/sweep stroke width. Default: follows `strokeWidth`. */
    ...
    <>
      ...
      {sweepLoading ? (
        <LineLoadingSweep
          ...
          strokeWidth={loadingStrokeWidth ?? strokeWidth}
          withArea
        />
      ) : null}
      {pulseLoading && pathD ? (
