...
export interface ChartContextValue extends ChartHoverContextValue {
  ...
  /** Formats axis/tick date labels wherever one is derived from a raw date
   * (domain ticks, projection tails); default is `shortDateFmt`. */
...
export function ChartProvider({
  ...
  const stable = useMemo<ChartStableContextValue>(
    () => ({
      ...
      xLabelFormat: value.xLabelFormat,
